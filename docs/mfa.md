...
You can enable Multi-Factor Authentication (MFA) to further protect your account. This can be enabled in [SOC](security-onion-console.md) by clicking the user icon in the upper-right corner, clicking `Settings`, and then going to the `Security` tab. 
...
!!! NOTE
    ...
    If you lose access to your authenticator app, an administrator can reset your password using the [Administration](administration.md) interface which will also remove the TOTP from your account.
...
!!! NOTE
    ...
    If you lose access to your security key device, an administrator can reset your password using the [Administration](administration.md) interface which will also remove the security keys from your account.
