...
We configure [Zeek](zeek.md) and [Suricata](suricata.md) to write logs to `/nsm/` in JSON format. If you want to parse those logs from the command line, then you can use `jq`.  Here's a basic example:
