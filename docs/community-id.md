...
Security Onion enables the built-in Community ID support in both [Zeek](zeek.md) and [Suricata](suricata.md).
...
[Dashboards](dashboards.md) includes a Community ID dashboard that will show all logs with that value.
