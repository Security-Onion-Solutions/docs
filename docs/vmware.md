...
- Customize hardware and increase Memory and Processors based on the [Hardware](hardware.md) section.
...
- Click `Close`.
- Click `Finish`.
- Power on the virtual machine and then follow the installation steps for your desired installation type in the [Installation](installation.md) section.
...
- `Processors & Memory` screen appears. Increase processors and memory based on the [Hardware](hardware.md) section. Click the `Add Device...` button.
