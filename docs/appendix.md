...
!!! TIP
    ...
    If you're planning to purchase new hardware, please consider official Security Onion appliances from Security Onion Solutions (<https://securityonionsolutions.com>). Our custom appliances have already been designed for certain roles and traffic levels and have Security Onion 2 pre-installed.
...
First, make sure that your 2.3 installation is fully updated via [soup](soup.md):
...
Boot the Security Onion 2.4 ISO image and go through the initial OS installation as shown in the [installation](installation.md) section.
...
Run through setup as described in the [Configuration](configuration.md) section.
