...
After changing the `SOC Telemetry` configuration setting, the grid must be resynchronized. [Auto State Apply](salt.md#auto-state-apply) does this automatically within a few minutes. Grid synchronization can take several minutes to complete.
...
After changing this configuration setting, the grid must be resynchronized. [Auto State Apply](salt.md#auto-state-apply) does this automatically within a few minutes. Grid synchronization can take several minutes to complete.
